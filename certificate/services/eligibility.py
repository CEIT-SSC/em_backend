...
def check_presentation_eligibility(user, enrollment_pk):
    """
...
def check_solo_competition_eligibility(user, registration_id):
    """
...
def check_group_competition_eligibility(user, team_id):
    """
