import type { TeamContent, GroupCompetition, TeamMembershipUserDetail, SoloCompetition, Presentation, Presenter, TeamMembership, ContentComment, MemberDetailSubmit } from '../default';
...
export enum StatusChoiceEnumValues {
    ...
    completed_or_free = 'Completed/Free',
    payment_failed = 'Payment Failed',
    cancelled = 'Cancelled',
}
