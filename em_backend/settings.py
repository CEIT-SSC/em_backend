...
WALLET_PAYMENT_START_URL = os.getenv("WALLET_PAYMENT_START_URL", default="")
WALLET_PAYMENT_RETURN_URL = os.getenv("WALLET_PAYMENT_RETURN_URL", default="")
...
TAILWIND_CLI_VERSION = os.getenv('TAILWIND_CLI_VERSION', '4.3.3')
