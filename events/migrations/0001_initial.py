# Generated by Django 5.2.1 on 2025-09-09 23:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Event',
            fields=[
                ('id', models.IntegerField(primary_key=True, serialize=False, verbose_name='Event ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='events.event', verbose_name='Parent Event')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('course', 'course'), ('talk', 'Talk'), ('workshop', 'Workshop')], default='talk', max_length=10, verbose_name='Type')),
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='Is Active for Registration?')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('event', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='presentations', to='events.event', verbose_name='Parent Event')),
                ('presenters', models.ManyToManyField(blank=True, related_name='presentations', to='events.presenter', verbose_name='Presenters')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_item', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='presentation_enrollment_record_link', to='shop.orderitem')),
                ('presentation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='enrollments', to='events.presentation')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='presentation_enrollments', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_item', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='solo_registration_record_link', to='shop.orderitem')),
                ('solo_competition', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='registrations', to='events.solocompetition')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='solo_competition_registrations', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='memberships', to='events.competitionteam', verbose_name='Team')),
